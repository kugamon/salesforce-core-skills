...
[Standing org monitoring recipe (Cowork)](docs/monitoring-recipe.md) · [Eval methodology](evals/README.md) · [Sample animated audit report](docs/demo/sample-audit-report.html) (download and open — single-file HTML) · [CHANGELOG](CHANGELOG.md)
